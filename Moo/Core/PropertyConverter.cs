...
namespace Moo.Core
{
    ...
    public class PropertyConverter : IPropertyConverter
    {
        ...
        public bool CanConvert(PropertyInfo sourceProperty, PropertyInfo targetProperty)
        {
            ...
            bool isConvertible = CanConvert(sourceProperty, targetProperty, out innerProp);
            ...
            bool strict)
        {
            ...
            if (source != null)
            {
                object fromContent = sourceProperty.GetValue(source, null);
                object toContent = CreateValueConverter().Convert(fromContent, sourceProperty.PropertyType);
        ...
        /// <param name="finalProperty">
        ///     <c>out</c> parameter, will contain the final destination
        ///     in case of a nested conversion (conversion targetMember a property within
        ///     the "targetMember" property).
        /// </param>
        /// <returns>
